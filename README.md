...
- Kibana только на `127.0.0.1:5601` на сервере; доступ: `ssh -L 5601:127.0.0.1:5601 USER@HOST`, затем http://localhost:5601 (логин `elastic`, пароль из `TEST_STAND_ELK_ENV_FILE`).
